<template>
    <div>
        <div class="album">
            ...
            <div class="album-info">
                ...
                <div class="album-info-control clearfix">
                    ...
                    <span @click="toggleList=!toggleList" class="album-info-control-menu">列表</span>
                </div>
            </div> 
        </div>
        ...
        <ul class="lrclist" ref="lrclist">
             <li :class=" lrcIndex==index?'selected': '' " v-for="(lrc,index) in lrcList" :key="lrc.time">{{lrc.lrc}}</li>
        </ul>
    </div>
...
export default {
  ...
  data() {
    return {
      nowIndex: -1, 
      albumImg:
      "https://www.faxingzhan.com/uploads/180710/12_213703_1.jpg",
      albumTitle: "", 
      albumAuthor: "", 
      isPlay: false, 
      toggleList: true, 
